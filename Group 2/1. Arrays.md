...
- Array Manipulation / Simulation (No hidden trick.)
...
- K-Sum Family (Sort + Two Pointers + Fix Elements.)
    - 2 Sum
    - 3 Sum
    - 4 Sum

- Array Optimization Patterns (Classic "famous trick" problems.)
...
- Divide & Conquer Counting (Modified Merge Sort)
    - Count Inversions
    - Reverse Pairs
